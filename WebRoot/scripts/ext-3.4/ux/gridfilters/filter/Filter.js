...
Ext.ux.grid.filter.Filter = Ext.extend(Ext.util.Observable, {
    ...
    /**
     * @cfg {Boolean} active
     * Indicates the initial status of the filterSpace (defaults to false).
     */
    activeFlag : false,
    /**
    ...
    setActive : function(active, suppressEvent){
        if(this.active != active){
            if(this.activeFlag == active && active != false){
    ...
    setFlag : function (activeFlag, suppressEvent){
    	 if(this.activeFlag != activeFlag){
            this.activeFlag = activeFlag;
            if(this.active == activeFlag && activeFlag != false){
            	this.active = !activeFlag;
            }
            if (suppressEvent !== true) {
                this.fireEvent(activeFlag ? 'activeFlag' : 'deactiveFlag', this);
            }
        }
    }
});